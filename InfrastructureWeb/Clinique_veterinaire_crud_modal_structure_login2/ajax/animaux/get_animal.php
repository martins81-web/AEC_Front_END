<?php
    ...
    if ($requete = $mysqli->prepare("SELECT animaux.*,  animaux.id AS id, type FROM animaux INNER JOIN types ON animaux.id_type=types.id WHERE animaux.id=?")) {  // Création d'une requête préparée 

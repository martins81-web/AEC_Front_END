            ...
            <Form>
                ...
                <Form.Group as={Row} controlId="writers">
                    ...
                    <Form.Group as={Col} controlId="writers2">
                        <Form.Control type="text"  defaultValue={typeof(this.state.data.writers[1].name) }/>
                    </Form.Group>
                    <Form.Group as={Col} controlId="writers3" defaultValue={typeof(this.state.data.writers[2].name) } >

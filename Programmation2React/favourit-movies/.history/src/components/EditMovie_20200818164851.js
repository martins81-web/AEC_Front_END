            ...
            <Form>
                ...
                <Form.Group as={Row} controlId="stars">
                    ...
                    <Form.Group as={Col} controlId="stars2">
                        <Form.Control type="text" defaultValue={typeof(this.state.data.stars[1].name)!= "undifined" } />
                    </Form.Group>
                    <Form.Group as={Col} controlId="stars3">
                        <Form.Control type="text" defaultValue={typeof (this.state.data.stars[2].name)!= 'undifined' } />
                    </Form.Group>
                </Form.Group>

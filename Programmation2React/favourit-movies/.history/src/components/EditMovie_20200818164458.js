            ...
            <Form>
                ...
                <Form.Group as={Row} controlId="writers">
                    ...
                    <Form.Group as={Col} controlId="writers2">
                        <Form.Control type="text"  defaultValue={!this.state.data.writers[1].name==='undifined' && this.state.data.writers[1].name}/>
                    </Form.Group>
                    <Form.Group as={Col} controlId="writers3" defaultValue={!this.state.data.writers[2].name==='undifined' && this.state.data.writers[2].name} >
                ...
                <Form.Group as={Row} controlId="stars">
                    ...
                    <Form.Group as={Col} controlId="stars2">
                        <Form.Control type="text" defaultValue={!this.state.data.stars[1].name==='undifined' &&this.state.data.stars[1].name}  />
                    </Form.Group>
                    <Form.Group as={Col} controlId="stars3">
                        <Form.Control type="text" defaultValue={!this.state.data.stars[2].name==='undifined' && this.state.data.stars[2].name} />
                    </Form.Group>
                </Form.Group>
